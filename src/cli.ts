...
export function exampleHelp() {
  console.log('\n  Example:');
  console.log('    \x1b[35myarn\x1b[0m create antdp \x1b[33mappName\x1b[0m');
  console.log('    \x1b[35mnpx\x1b[0m create-antdp \x1b[33mmy-app\x1b[0m');
  console.log('    \x1b[35mnpm\x1b[0m create antdp \x1b[33mmy-app\x1b[0m');
  console.log('    \x1b[35mnpm\x1b[0m create antdp \x1b[33mmy-app\x1b[0m -f');
  console.log(
    '    \x1b[35mnpm\x1b[0m create antdp \x1b[33mmy-app\x1b[0m -p \x1b[34mhttps://antdpro.github.io/antdp\x1b[0m',
  );
}
